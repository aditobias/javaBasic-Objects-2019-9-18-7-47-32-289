...
class InheritanceTest {
    ...
    void should_be_derived_from_object_class() {
        ...
        // <--start
        final Class<?> expectedSuperClass = Optional.class.getSuperclass();
        // --end-->
    ...
    void should_call_super_class_constructor_continued() {
        ...
        final String[] expected = {"SuperClassWithDefaultConstructor.constructor()",
                "DerivedFromSuperClassWithDefaultConstructor.constructor()", "DerivedFromSuperClassWithDefaultConstructor.constructor(int)"};
        // --end-->
